...
本项目为专有软件，版权所有 (c) 2026 wangwayhome，保留所有权利。

未经版权所有者事先书面授权，任何个人或组织不得使用、复制、修改、发布、分发、再许可、销售、商业化、部署、托管、反向工程，或基于本项目创建衍生作品。

如需使用本项目或其中任何部分，必须先向版权所有者申请并取得书面授权。完整条款见 [LICENSE](LICENSE)。
